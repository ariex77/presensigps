    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="kode_libur" class="form-control" value="{{ $harilibur->kode_libur }}" placeholder="Auto" name="kode_libur" disabled>
              </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="tanggal_libur" class="form-control" placeholder="Tanggal libur" name="tanggal_libur" autocomplete="off" value="{{ $harilibur->tanggal_libur }}">
              </div>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-12">
            <div class="form-group">
                <select name="kode_cabang" id="kode_cabang" class="form-select">
                    ...
                    @foreach ($cabang as $d)
                        <option {{ $harilibur->kode_cabang == $d->kode_cabang ? 'selected' : '' }} value="{{ $d->kode_cabang }}">{{ strtoupper($d->nama_cabang) }}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="keterangan" class="form-control" placeholder="Keterangan" name="keterangan" autocomplete="off" value="{{ $harilibur->keterangan }}">
              </div>
        </div>
    </div>
    <div class="row mt-2">
