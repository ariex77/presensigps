    ...
    <div class="row mb-2" id="frm_jam_in">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="jam_in" value="{{ $presensi != null ? $presensi->jam_in : '' }}" class="form-control" placeholder="Jam masuk" name="jam_in">
              </div>
        </div>
    </div>
    <div class="row mb-2" id="frm_jam_out">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="jam_out" value="{{ $presensi != null ? $presensi->jam_out : '' }}" class="form-control" placeholder="Jam pulang" name="jam_out">
              </div>
        </div>
    </div>
