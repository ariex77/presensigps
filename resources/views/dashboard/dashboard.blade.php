    ...
    <div class="section" id="user-section">
        ...
        <div id="user-detail">
            <div class="avatar">
                ...
                @endphp
                    <img src="{{ url($path) }}" alt="avatar" class="imaged w64" style="object-fit: cover">
                @else
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center"  style="padding:12px 12px !important; line-height:0.8rem">
                            <span class="badge bg-danger" 
                            style="position: absolute; top:3px; right:10px; font-size:0.6rem; z-index:999">
                            {{ $rekappresensi->jmlcuti }}</span>
                            <ion-icon name="document-outline" style="font-size: 1.6rem;" class='text-danger mb-1'></ion-icon>
                            <br>
                            ...
                            <div class="in">
                                <div>{{ date("d-m-Y", strtotime($d->tgl_presensi)) }}</div>
                                    ...
                                    <span class="badge badge-danger">
                                        {{ $presensihariini != null && $d->jam_out !=null ? 
